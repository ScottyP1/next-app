                ...
                {vSrc ?
                    <div>
                        <video autoPlay playsInline muted loop
                            className='object-cover absolute top-[1008px] lg:top-[1008px] xl:top-[1010px] 2xl:top-[1140px] left-[60px] md:left-[100px] lg:left-[275px] xl:left-[508px] 2xl:left-[905px] w-[310px] md:w-[480px]'>
